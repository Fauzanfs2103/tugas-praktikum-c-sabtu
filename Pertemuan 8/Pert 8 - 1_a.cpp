...
int main() {
	...
	printf("\n");
    printf("  FFFFF  AAAAA  U     U  ZZZZZ  AAAAA  N     N\n");
    printf("  F      A   A  U     U      Z  A   A  NN    N\n");
    printf("  FFFFF  AAAAA  U     U     Z   AAAAA  N N   N\n");
    printf("  F      A   A  U     U    Z    A   A  N  N  N\n");
    printf("  F      A   A   UUUUU   ZZZZZ  A   A  N   N N\n");
